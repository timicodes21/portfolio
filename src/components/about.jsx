                ...
                <div className='mx-md-5'>
                    <Row className='mx-md-5 pt-5 gx-md-5'>
                        <div className="col-md-3 col-6 mb-3">
                            <div className="d-none d-md-block"><Image fluid src={userfriendly} /></div>
                            <div className="d-md-none mobile-icon"><Image fluid src={userfriendly} /></div>
                        ...
                        <div className="col-md-3 col-6 mb-3">
                        <div className="d-none d-md-block"><Image fluid src={responsive} /></div>
                            <div className="d-md-none mobile-icon"><Image fluid src={responsive} /></div>
                            <div className="text-center my-3">
                        ...
                        <div className="col-md-3 col-6 mb-3">
                            <div className="d-none d-md-block"><Image fluid src={intuitive} /></div>
                            <div className="d-md-none mobile-icon"><Image fluid src={intuitive} /></div>
                            <div className="text-center my-3">
                        ...
                        <div className="col-md-3 col-6 mb-3">
                            <div className="d-none d-md-block"><Image fluid src={dynamic} /></div>
                            <div className="d-md-none mobile-icon"><Image fluid src={dynamic} /></div>
                            <div className="text-center my-3">
