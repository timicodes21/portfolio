      ...
      <section id="footer" className="text-center">
        <Container>
          <div>
                ...
                <div className="col-12 col-md-4">
                  <Row className="px-5">
                    ...
                    <div className="col-3">
                      <div className="social-div pointer">
                        <a
                          href="https://wa.me/+2348124793586"
                          target="_blank"
                          rel="noreferrer"
                        >
                          <FaWhatsapp />
                    ...
                    <div className="col-3">
                      <div className="social-div pointer" target="_blank">
                        <a
                          href="https://github.com/timicodes21"
                          target="_blank"
                          rel="noreferrer"
                        >
                          <FaGithub />
                    ...
                    <div className="col-3">
                      <div className="social-div pointer">
                        <a
                          href="https://www.instagram.com/dev_timi/"
                          target="_blank"
                          rel="noreferrer"
                        >
                          <FaInstagramSquare />
            ...
            <div>
              <p className="font-12 text-ash">
                TIMILEYIN BABALOLA{" "}
                <span className="text-pink">&#169; 2022</span>{" "}
              </p>
            </div>
          </div>
        </Container>
